/**
 *  @file  ubcc1pi_standalone/Macros/PlotEventSelectionCutsRun4Validation.cxx
 *
 *  @brief The implementation file of the PlotEventSelectionCutsRun4Validation macro
 */
...
void PlotEventSelectionCutsRun4Validation(const Config &config)
{
    //
 ...
 for (const auto run: config.global.runs)
    {
        ...
        else throw std::logic_error("PlotEventSelectionCutsRun4Validation - Invalid run number");
    }
        ...
        for (unsigned int i = 0; i < nEvents; ++i)
        {
            ...
            if (wasInputToCut("likelyGoldenPion", cutsPassed))
            {
                ...
                if (pionIter == assignedPdgCodes.end())
                    throw std::logic_error("PlotEventSelectionCutsRun4Validation - No pion candidate found");
                ...
                if (!hasFeatures)
                    throw std::logic_error("PlotEventSelectionCutsRun4Validation - Pion candidate doesn't have BDT features");
    ...
    nTracksPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_min2Tracks_nTracks");
    isContainedPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_max1Uncontained_isContained");
    uncontainedVertexDistPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_max1Uncontained_vertexDist_uncontainedParticles", true);
    nUncontainedPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_max1Uncontained_nUncontained");
    protonBDTResponsePlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_2NonProtons_protonBDTResponse");
    recoProtonMomentumPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_recoProtonMomentumPlot");
    trueProtonMomentumPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_trueProtonMomentumPlot");
    nNonProtonsPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_2NonProtons_nNonProtons");
    truncatedMeandEdxBeforePlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_pionTruncatedMeandEdx-before");
    truncatedMeandEdxAfterPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_pionTruncatedMeandEdx-after");
    openingAnglePlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_openingAngle_openingAngle");
    pionNotInGapBeforePlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_pionNotInGap_pionPhi-before");
    pionNotInGapAfterPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_pionNotInGap_pionPhi-after");
    topologicalScorePlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_topologicalScore_topologicalScore", false, false, true);
    startNearVertexParticlePlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_startNearVertex_vertexDist_allParticles", true);
    startNearVertexEventPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_startNearVertex_vertexDist_furthestParticle", true);
    likelyGoldenPionParticlePlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_likelyGoldenPion_goldenPionBDTResponse_particles");
    likelyGoldenPionEventPlot.SaveAsStacked("PlotEventSelectionCutsRun4Validation_" + prefix + "_likelyGoldenPion_goldenPionBDTResponse_events");
}
